...
export type UpdateMiscDeliveryDataProps = {
...
export async function updateMiscDelivery(data: UpdateMiscDeliveryDataProps) {
  try {
    ...
    const valueDiffs = {
      ...
      emptyBottles: data.data.empty_bottles - data.Miscellaneous.empty_bottles,
      damagedBottles:
