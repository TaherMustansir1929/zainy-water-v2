...
import { BatteryPlus, Loader2, SendHorizonal, SquarePlus } from "lucide-react";
...
import { useCreateBottleUsage } from "@/queries/moderator/useCreateBottleUsage";
import { BottleUsageTable } from "./bottle-usage-table";
import { useFetchBottleUsage } from "@/queries/moderator/useFetchBottleUsage";
...
export const BottleUsageForm = () => {
  ...
  const bottleUsageQuery = useFetchBottleUsage(moderator_id ?? null);
  const bottleUsageMutation = useCreateBottleUsage();
